...
export function useSteps(): St[] {
  ...
  return useMemo<St[]>(
    () => [
      {
        id: "amount",
        label: t("solana.undelegation.flow.steps.amount.title"),
      ...
      {
        id: "device",
        label: t("solana.undelegation.flow.steps.device.title"),
        component: GenericStepConnectDevice,
        onBack: ({ transitionTo }: StepProps) => transitionTo("amount"),
      },
      {
        id: "confirmation",
        label: t("solana.undelegation.flow.steps.confirmation.title"),
